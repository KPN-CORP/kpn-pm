                    ...
                    <div class="card-body">
                        <div class="row px-2">
                            ...
                            <div class="col-lg col-sm-12 p-2">
                                ...
                                <p class="mt-2 mb-0 text-muted">{{ $row->request->updatedBy ? $row->request->updatedBy->name.' '.$row->request->updatedBy->employee_id : '-' }}{{ $row->request->updated_by != auth()->user()->id && empty($adjustByManager) && auth()->check() && auth()->user()->roles->isNotEmpty() ? ' (Admin)': '' }}</p>
                            </div>
                            <div class="col-lg col-sm-12 p-2">
                                <h5>Status</h5>
                                <div>
