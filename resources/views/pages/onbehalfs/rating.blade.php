                                ...
                                @php
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md text-end order-1 order-md-2 mb-2">
                                            <a class="btn btn-outline-info m-1 {{((!$calibratorCount && !$ratingDone ) || $requestApproved) ? '' : 'd-none' }}" data-bs-toggle="modal" data-bs-id="{{ $level }}" data-bs-target="#importModal{{ $level }}" title="Import Rating"><i class="ri-upload-cloud-2-line d-md-none"></i><span class="d-none d-md-block">Upload Rating</span></a>
                                    ...
                                    <div class="employee-list-container" data-level="{{ $level }}">
                                        ...
                                        <div id="employeeList-{{ $level }}">
                                            <form id="formRating{{ $level }}" action="{{ route('rating.submit') }}" class="d-grid gap-3" method="post">
                                                ...
                                                <input type="text" name="approver_id" id="approver_id" value="{{ Auth::user()->employee_id }}">
