            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg col-md-12 p-2">
                        <span class="text-muted">Weightage</span>
                    ...
                    <div class="col-lg col-md-12 p-2">
                        <span class="text-muted">Target in {{ is_null($data['custom_uom']) ? $data['uom']: $data['custom_uom'] }}</span>
                        <p class="mt-1">{{ $data['target'] }}</p>
                    </div>
                    <div class="col-lg-2 col-md-12 p-2">
                        <span class="text-muted">Achievement in {{ is_null($data['custom_uom']) ? $data['uom']: $data['custom_uom'] }}</span>
                        <input type="text" id="achievement-{{ $index + 1 }}" name="formData[{{ $formIndex }}][{{ $index }}][achievement]" placeholder="Enter achievement.." value="{{ isset($data['actual']) ? $data['actual'] : "" }}" class="form-control mt-1" />
            ...
            <td scope="row fs-16">
                ...
                <div class="row">
                    ...
                    <div class="col-9 col-md-4 col-form-label">
                        <input type="text" id="achievement-{{ $index + 1 }}" name="formData[{{ $formIndex }}][{{ $index }}][achievement]" placeholder="Enter achievement.." value="{{ isset($data['actual']) ? $data['actual'] : "" }}" class="form-control" />
                            <div class="text-danger error-message"></div>
                    </div>
                </div>
            </td>
