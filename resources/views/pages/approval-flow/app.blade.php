    ...
    <div class="row">
        <div class="col">
            <div class="text-end mb-2">
                <a href="{{ route('approval-flow.create', 'flow') }}" class="btn btn-sm btn-primary">Create Approval Flow</a>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                @if ($flows->isEmpty())
                    <p class="text-center m-0 text-gray-600">No approval workflow has been created.</p>
                @else
                    <table id="tableApprovalFlow" class="table table-hover m-0">
                        <thead class="thead-light">
                            <tr>
                                <th class="table-header rounded-tl-lg">Name</th>
...
@push('scripts')
<script>
    window.tableUrl = "{{ route('approval-flow.data') }}";
</script>
@endpush