@extends('layouts_.vertical', ['page_title' => 'Achievement'])
      ...
      <!-- Modal Pop-Up -->
        <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="importModalLabel">Import Achievement</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                            ...
                            {{-- <div class="row">
                                <div class="col">
                                    <div class="alert alert-info">
                                        <strong>Notes:</strong>
                                        <ul class="mb-0">
                                            <li>Template Import Achievement can use from the File Export at menu Reports : <strong>Reports -> Detailed Goals -> Download</strong></li>
                                        </ul>
                                    </div>
                                </div>
                            </div> --}}
