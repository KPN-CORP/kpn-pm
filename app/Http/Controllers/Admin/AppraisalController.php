    ...
    public function index(Request $request)
{
    ...
    $period = $filterInputs['period'] ?? $this->appService->appraisalPeriod();
     ...
     * ================================ */
    $groupCompanies = $this->getGroupCompanies();
...
private function getGroupCompanies()
{
    return EmployeeAppraisal::select('group_company')
        ->distinct()
